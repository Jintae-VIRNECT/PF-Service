package com.virnect.platform.license.application;

import static com.virnect.platform.license.domain.licenseplan.PlanStatus.*;
...
import com.virnect.platform.feign.rest.content.ContentRestService;
import com.virnect.platform.feign.rest.remote.RemoteRestService;
import com.virnect.platform.feign.rest.workspace.WorkspaceRestService;
import com.virnect.platform.global.common.ApiResponse;
import com.virnect.platform.global.common.PageMetadataResponse;
import com.virnect.platform.global.common.PageRequest;
...
import com.virnect.platform.license.domain.license.LicenseStatus;
...
import com.virnect.platform.license.dto.ResourceCalculate;
import com.virnect.platform.license.dto.UserLicenseDetailsInfo;
import com.virnect.platform.license.dto.license.response.LicenseInfoResponse;
import com.virnect.platform.license.dto.license.response.LicenseProductInfoResponse;
import com.virnect.platform.license.dto.license.response.LicenseRevokeResponse;
import com.virnect.platform.license.dto.license.response.LicenseSecessionResponse;
import com.virnect.platform.license.dto.license.response.MyLicenseInfoListResponse;
import com.virnect.platform.license.dto.license.response.MyLicenseInfoResponse;
import com.virnect.platform.license.dto.license.response.MyLicensePlanInfoListResponse;
import com.virnect.platform.license.dto.license.response.MyLicensePlanInfoResponse;
import com.virnect.platform.license.dto.license.response.UserLicenseInfo;
import com.virnect.platform.license.dto.license.response.UserLicenseInfoResponse;
...
import com.virnect.platform.license.dto.rest.user.WorkspaceInfoResponse;
import com.virnect.platform.license.event.license.LicenseExpiredEvent;
import com.virnect.platform.license.exception.LicenseServiceException;
...
public class LicenseService {
	...
	public LicenseRevokeResponse userLicenseRevokeRequestHandler(
		...
		log.info("[LICENSE DEALLOCATE_PUSH_MESSAGE_REQUEST] - {}", licenseExpiredEvent);
	...
	public ApiResponse<MyLicensePlanInfoListResponse> getMyLicensePlanInfoList(String userId, PageRequest pageRequest) {
		...
		for (UserLicenseDetailsInfo detailsInfo : licenseDetailsInfoList) {
			...
			if (workspaceInfoResponse.getUuid() == null || workspaceInfoResponse.getUuid().isEmpty()) {
				log.info("[WORKSPACE_NOT_FOUND] - {}", detailsInfo);
				continue;
			}
