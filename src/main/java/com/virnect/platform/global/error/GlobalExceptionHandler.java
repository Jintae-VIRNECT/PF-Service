...
import com.virnect.platform.license.exception.LicenseAllocateDeniedException;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorResponseMessage> billingServiceException(BillingServiceException e) {
		log.error("[LICENSE_SERVICE - BILLING SERVICE - EXCEPTION] - MESSAGE: [{}] , DATA: [{}]", e.getMessage(),
			e.getError()
		);
		return ResponseEntity.ok(new ErrorResponseMessage(e.getError()));
	}
