...
@Slf4j
@Component
public class AccountRestServiceHandler {
	...
	public UserInfoRestResponse getUserRequest(String userId) {
		com.virnect.platform.global.common.ApiResponse<UserInfoRestResponse> response = userRestService.getUserInfoByUserId(userId);
